...
class SearchExpenses implements Tool
{
    ...
    {
        return 'Busca gastos del presupuesto actual, puedes filtrar por nombre, gastos más baratos, más caros, totales, buscar por categoría, etc, y mostrar todos los gastos del presupuesto.';
    }
    ...
    {
        return [
            'name' => $schema->string()->description('Texto para buscar en el nombre del gasto. (ej: Uber, comida, renta, dentista, etc.)'),
            'category' => $schema->string()->description('Categoría del gasto. (ej: food, transportation, hosuing, suscriptions, other)'),
        ];
    }
}
